...
const News = () => {
  ...
  const getNews = () => {
    ...
    axios.get('https://newsapi.org/v2/everything', {
      params: {
        q: 'farming OR agriculture OR farmer OR kisan',
        sortBy: 'publishedAt',
  ...
  return (
    ...
    <h1 className="text-2xl mb-10 md:text-3xl font-bold mb-6 text-left border-l-4 border-green-500 pl-4">Farming News</h1>
